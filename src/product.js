...
let apartmentPlantTips = [
    ...
    { id: 4, name: 'گیاه پاچیرا', price: 2_700_000, categoriFn: "گیاهان آپارتمانی", categoriEn: 'apartmentPlantTip', performance: 3.6, property: { vaseMt: 'پلاستیک', sol: 'خاک گلدانی شنی و غنی', wight: 3000, size: '۲۵۰x۲۵۰x۸۰۰', sunLike: "آفتاب دوست" }, sender: "سبزوار شاپ", img: ['/image/categoty img/cat_1_4.png'], cunt: 1 }
]
