            ...
            <div className='w-full h-full flex flex-col items-center justify-center'>
                <div className='w-[540px] h-[485px] flex flex-col items-start justify-center'>
                    ...
                    <form action="" className='w-full'>
                        <div className='border border-customgray3 rounded-xl flex relative gap-2 w-full py-3 px-3.5 text-customgray3'>
                            <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 0 0 6 3.75v16.5a2.25 2.25 0 0 0 2.25 2.25h7.5A2.25 2.25 0 0 0 18 20.25V3.75a2.25 2.25 0 0 0-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
                            </svg>
                            <label htmlFor="" className='absolute'>شماره موبایل</label>
                        ...
                        <div className='border border-customgray3 rounded-xl flex relative gap-2 w-full py-3 px-3.5 text-customgray3'>
                            <label htmlFor="">تعریف رمز عبور</label>
                            <div>
