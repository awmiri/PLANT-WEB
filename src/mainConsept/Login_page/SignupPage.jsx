                ...
                <div className='w-[540px] h-[485px] flex flex-col items-start justify-center'>
                    ...
                    <form action="" className='w-full flex flex-col gap-6'>
                        <div className={`border-2 ${!focusesMobile ? 'border-customgray3' : 'border-hightGreen'} rounded-xl flex relative gap-2 w-full py-3 px-3.5 text-customgray3 transition`}>
                            ...
                            <input type="number" className='w-full outline-0' onFocus={() => { setFocusesMobile(true) }} onBlur={(event) => { if (event.target.value.trim() === "") { setFocusesMobile(false) } }} value={Mobile} onChange={(e) => setMobile(e.target.value)} />
                        </div>
                        ...
                        <div className={`border-2 ${!focusesPassword ? 'border-customgray3' : 'border-hightGreen'} rounded-xl flex relative gap-2 w-full py-3 px-3.5 text-customgray3 transition`}>
                            ...
                            <div className='w-full flex items-center'>
                                ...
                                <input type="password" className='w-full outline-0 ' onFocus={() => { setFocusesPassword(true) }} onBlur={(event) => { if (event.target.value.trim() === "") { setFocusesPassword(false) } }} />
                            </div>
                        ...
                        <div className={`border-2 ${!focusesPassword ? 'border-customgray3' : 'border-hightGreen'} rounded-xl flex relative gap-2 w-full py-3 px-3.5 text-customgray3 transition`}>
                            ...
                            <div className='w-full flex items-center'>
                                ...
                                <input type="password" className='w-full outline-0 ' onFocus={() => { setFocusesRepass(true) }} onBlur={(event) => { if (event.target.value.trim() === "") { setFocusesRepass(false) } }} />
                            </div>
                            <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3.98 8.223A10.477 10.477 0 0 0 1.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.451 10.451 0 0 1 12 4.5c4.756 0 8.773 3.162 10.065 7.498a10.522 10.522 0 0 1-4.293 5.774M6.228 6.228 3 3m3.228 3.228 3.65 3.65m7.894 7.894L21 21m-3.228-3.228-3.65-3.65m0 0a3 3 0 1 0-4.243-4.243m4.242 4.242L9.88 9.88" />
                            </svg>
                        ...
                        <button className='bg-hightGreen py-3 text-white rounded-xl font-vazirMediom'>ثبت نام</button>
